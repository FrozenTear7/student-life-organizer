...
from [`src/index.js`](../my-app/src/index.js).

If you had previously enabled service workers in your production deployment and
have decided that you would like to disable them for all your existing users,
you can swap out the call to `serviceWorkerRegistration.register()` in
[`src/index.js`](../my-app/src/index.js) with a call to `serviceWorkerRegistration.unregister()`.
...
in all web browsers. Service worker registration [won't be attempted](../my-app/src/registerServiceWorker.js)
...
starting point, you can make use of the logic included in [`src/registerServiceWorker.js`](../my-app/src/registerServiceWorker.js), which
...
[`public/manifest.json`](../my-app/public/manifest.json), that you can customize with
details specific to your web application.

When a user adds a web app to their homescreen using Chrome or Firefox on
Android, the metadata in [`manifest.json`](../my-app/public/manifest.json) determines what
