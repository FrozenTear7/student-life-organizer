...
export const addTodo = (text, highPriority) => ({
    type: ADD_TODO,
    id: nextTodoId++,
    text,
    highPriority
...
export const updateTodo = (id, text, highPriority) => ({
    type: UPDATE_TODO,
    id,
    text,
    highPriority
...
export const addExam = (text, highPriority) => ({
    type: ADD_EXAM,
    id: nextExamId++,
    text,
    highPriority
...
export const updateExam = (id, text, highPriority) => ({
    type: UPDATE_EXAM,
    id,
    text,
    highPriority
